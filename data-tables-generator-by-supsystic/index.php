...
if (file_exists($proPluginPath)) {
    ...
    if (
        ...
        version_compare($pluginData["Version"], "1.7.12", "<")
    ) {
...
if (!function_exists("supsystic_tables_get")) {
    ...
    {
        return do_shortcode(
            sprintf('[%s id="%d"]', SUPSYSTIC_TABLES_SHORTCODE_NAME, (int) $id)
        );
    }
}
